...
public class EditarProductoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnActualizar.setOnClickListener(view -> {
            ...
            String nuevaDescripcion = edtDescrip.getText().toString();
            ...
            if (databaseHelper.actualizarProducto(productoId,nuevaDescripcion, nuevoNombre, nuevoPrecio, nuevoStock, nuevoUrl) > 0) {
